...
// Control (excl. tab/LF/CR), zero-width, bidi-override, tag-block and angle-bracket characters
// must never be echoed verbatim into a warning that itself becomes trusted hook context --
// defangs Trojan-Source-style payloads and fake `<system>`-tag smuggling alike.
...
function excerptAt(text, index, len) {
  ...
  return sanitize(s.length > 100 ? s.slice(0, 100) : s);
}
...
module.exports = { scan, RULE_IDS, sanitize };
