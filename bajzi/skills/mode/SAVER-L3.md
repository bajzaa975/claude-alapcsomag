...
PRECEDENCE: at L3 this block OVERRIDES the day-run REVIEW LOOP and every "review -> OPUS 5" row. Queuing the review IS how those rows are met at L3; no sub-agent here is an Opus review, whatever model name it was given.
